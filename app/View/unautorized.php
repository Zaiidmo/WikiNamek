    ...
    <div class="grid h-screen px-4 place-content-center">
        <div class="text-center">
            ...
            <div class="flex flex-col items-center">
                <a href="home" class="inline-block w-1/2 px-5 py-3 mt-6 text-sm font-medium text-white bg-gray-600 rounded hover:bg-gray-700 focus:outline-none focus:ring">
                    Go Back Home
                </a>
                <a href="profile" class="inline-block px-5 py-3 mt-6 text-sm font-medium text-white bg-gray-600 rounded hover:bg-gray-700 focus:outline-none focus:ring">
                    Go To Your Profile
                </a>
            </div>
        </div>

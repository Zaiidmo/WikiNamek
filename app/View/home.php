    ...
    <section class="bg-gray-300 dark:bg-gray-900 pt-24">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto justify-center items-center align-middle lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            ...
            <div class="mr-auto place-self-center text-center lg:col-span-7">
                ...
                <a href="#" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-800  rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                    Discover Wikis
                </a>
                <a href="#" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-gray-800 dark:text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                    Get started
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:px-6 ">
            ...
            <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2 lg:grid-cols-3">
                <div class="max-w-sm bg-gray-300 border border-gray-200 rounded-lg shadow dark:bg-gray-900 dark:border-gray-700">
                    <a href="#">
                        <img class="rounded-t-lg" src="<?= URL_DIR ?>public/assets/images/image.jpg" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="#">

                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex justify-center text-sm">
                                        <a href="users/makeAdmin/?id=<?= $user['id'] ?>">
                                            <button data-user_Id="<?= $user['id'] ?>" class="text-white dark:text-gray-400 bg-gray-700 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700" aria-label="Edit">
                                                Make Admin
                                            </button>
                                        </a>
                                        <a href="Users/delete/?id=<?= $user['id'] ?>">
                                            <button onclick="confirmDelete()" class="deleteUser flex items-center justify-between text-white dark:text-gray-400 bg-gray-700 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700" aria-label="Delete">
